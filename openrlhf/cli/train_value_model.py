...
from openrlhf.datasets import RewardDataset, ValueDataset
from openrlhf.models import get_llm_for_sequence_regression
from openrlhf.trainer import RewardModelTrainer, OfflineCriticModelTrainer
...
def train(args):
    ...
    # 这里直接传进去一个jsonl读取到的list
    train_dataset = ValueDataset(train_data, tokenizer, args.max_len, strategy, input_template=args.input_template, response_micro_batch_size=args.response_micro_batch_size)
    eval_dataset = ValueDataset(eval_data, tokenizer, args.max_len, strategy, input_template=args.input_template, response_micro_batch_size=args.response_micro_batch_size)
    ...
    trainer = OfflineCriticModelTrainer(
        model=model,
        strategy=strategy,
        optim=optim,
        tokenizer=tokenizer,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--response_micro_batch_size", type=int, default=8)
